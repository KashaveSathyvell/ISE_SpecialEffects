...
player = Character(120, 250, "Knight", 75)
player.speed = 10  # Set speed as desired
...
enemy_positions = {
    ...
    "western_wing": [("Mob2", (200, 600)), ("Mob3", (-300, 1000))],
...
def spawn_enemies_for_area(area):
    global all_enemies
    all_enemies.empty()
    print(f"Spawning enemies for {area}")
...
while running:
    ...
    for enemy in all_enemies:
        ...
        print(f"Drawing {enemy} at ({enemy.rect.x}, {enemy.rect.y})")
    ...
    # --- New Player Drawing using Character's Mask ---
